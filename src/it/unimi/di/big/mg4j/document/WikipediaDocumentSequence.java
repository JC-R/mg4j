 ...
 * {@linkplain #WikipediaDocumentSequence(String, boolean, String, boolean, boolean, boolean, int, int, int) a quite humongous constructor}.
 * 
...
public class WikipediaDocumentSequence extends AbstractDocumentSequence implements Serializable {
	...
	public WikipediaDocumentSequence( final String file, final boolean bzipped, final String baseURL, final boolean parseText, final boolean keepNamespaced, final boolean keepTemplates ) {
		this( file, bzipped, baseURL, parseText, keepNamespaced, keepTemplates, HtmlDocumentFactory.DEFAULT_MAXPREANCHOR, HtmlDocumentFactory.DEFAULT_MAXANCHOR, HtmlDocumentFactory.DEFAULT_MAXPOSTANCHOR );
	}
	 ...
	 */
	public WikipediaDocumentSequence( final String file, final boolean bzipped, final String baseURL, final boolean parseText, final boolean keepNamespaced, final boolean keepTemplates, final int maxPreAnchor, final int maxAnchor, final int maxPostAnchor ) {
	...
	/** A string-based constructor to be used with an {@link ObjectParser}.
	 *
	 * @see #WikipediaDocumentSequence(String, boolean, String, boolean, boolean, boolean, int, int, int)
	 */
	public WikipediaDocumentSequence( final String file, final String bzipped, final String baseURL, final String parseText, final String keepNamespaced, final String keepTemplates, final String maxBeforeAnchor, final String maxAnchor, final String maxPostAnchor ) {
		this( file, Boolean.parseBoolean( bzipped ), baseURL, Boolean.parseBoolean( parseText ), Boolean.parseBoolean( keepNamespaced ), Boolean.parseBoolean( keepTemplates ), Integer.parseInt( maxBeforeAnchor ), Integer.parseInt(  maxAnchor ), Integer.parseInt( maxPostAnchor ) );
	}
